...
exports.StatusCode = {
    ...
    ERR_GLOBAL_INVALID_CREDENTIALS: { ok: false, http: { status: 403 }, why: "invalid credentials" },
    ERR_GLOBAL_NOTFOUND: { ok: false, http: { status: 400 }, why: "requested information doesn't exist" },
