...
exports.fetchStates = function (req, res) {
    State.findByCondition({status: STATUS_ACTIVE}, function (err, States) {
        if (err) {
...
exports.saveStates = function (req, res) {
    ...
    let state = req.body.state
    State.findByCondition({ state_code: state.state_code, status: STATUS_ACTIVE }, function (err, statedb) {
